...
def test_throttle():
    for i in range(30):
        ...
        '''
        loop_for(0.5, pwm0.set_duty_cycle, 1.25+i/100*1.0)
        loop_for(0.5, pwm1.set_duty_cycle, 1.25+i/100*1.0)
        loop_for(0.5, pwm2.set_duty_cycle, 1.25+i/100*1.0)
        loop_for(0.5, pwm3.set_duty_cycle, 1.25+i/100*1.0)
