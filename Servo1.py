...
'''
    ...
    loop_for(7, pwm0.set_duty_cycle, SERVO_STOP)
    ...
    print("SERVO_MIN_AGAIN")
    loop_for(7, pwm1.set_duty_cycle, SERVO_STOP)
    ...
    print("SERVO_MIN_AGAIN")
    loop_for(7, pwm2.set_duty_cycle, SERVO_STOP)
    ...
    print("SERVO_MIN_AGAIN")
    loop_for(7, pwm3.set_duty_cycle, SERVO_STOP)
